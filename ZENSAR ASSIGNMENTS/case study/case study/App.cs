...
namespace case_study
{
    public class App
    {
        void Scenario1()
        {
            Student s1 = new Student("ash", "06/06/1996");
            s1.StudId = 01;
            Info.Display(s1);

            Student s2 = new Student("Sai", "15/10/1997");
            s1.StudId = 02;
            Info.Display(s2);
        }
        ...
        void Scenario2()
        {
            ...
            Sarr[1] = new Student(13, "01/10/1998", "Sri");
            Sarr[2] = new Student(14, "26/03/1996", "ram");
            Sarr[0] = new Student(15, "03/05/1998", "Hari");
